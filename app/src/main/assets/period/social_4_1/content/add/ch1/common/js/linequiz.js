...
//                    console.log(rightItem)
                    if (rightItem) {
                        ...
                        if(!self.overlap){
                            ...
                            if (l >= 0) {
                                var ll = $(rightItem).parents('.quizSec').find('#'+self._id+'_leftItem' + l)[0];
                ...
                $(document).unbind(upEvent).on(upEvent, function(e) {
                    ...
                    if (leftItem) {
                        ...
                        if(!self.overlap){
                            ...
                            console.log(r);
                            if (r >= 0) {
                                var rr = $(leftItem).parents('.quizSec').find('#'+self._id+'_rightItem' + r)[0];
    ...
    lineq.reset = function() {
        ...
        $(self.svg).find('line').each(function() {
            if ($(this).parent()[0] == self.svg && $(this).attr('stroke') == '#ff3300') $(this).remove();
        });
    ...
    lineq.createSVG = function() {
        ...
        for (var i = 0; i < this.leftItems.length; i++) {
            ...
            var line = this.createLine(item.ox, item.oy, item.ox, item.oy, "#0f74aa", 5, this._id+'_leftItem' + i);
        ...
        for (var i = 0; i < this.rightItems.length; i++) {
            ...
            item.ox = ($(item).offset().left - $('#wrap').offset().left) / factor + $(item).width() / 2;
            item.oy = ($(item).offset().top - $('#wrap').offset().top) / factor + $(item).height() / 2;
            var line = this.createLine(item.ox, item.oy, item.ox, item.oy, "#0f74aa", 5, this._id+'_rightItem' + i);
            this.lines.push(line);
