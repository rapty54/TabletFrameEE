...
$(function(){
    ...
    $(document).on("click",".eval_tooltip_list li button", function(e){
        ...
        var score_num = (Number($(score).data('score'))+move);
        ...
        $(".eval_tooltip").hide();
        $(score).data('score',score_num);
        $(score).fadeOut(500);

        setTimeout(function(){
            $(charactor_box1).find('.up').hide();
            $(charactor_box1).find('.down_gif').show();
            $(charactor_box1).find('.down_gif').attr('src',down_gif);

             setTimeout(function(){
                $(charactor_box1).find('.down_gif').hide();
                $(charactor_box1).css('bottom',location+'%');
                if(score_num >= $('#target_score').val()){ console.log('aa');
                    $(charactor_box1).addClass('full');
                    $(charactor_box1).find('.up_full_gif').show();
                    $(charactor_box1).find('.up_full_gif').attr('src',up_full_gif);
                } else {
                    $(charactor_box1).removeClass('full');
                    $(charactor_box1).find('.up_full_gif').hide();
                    $(charactor_box1).find('.up_gif').show();
                    $(charactor_box1).find('.up_gif').attr('src',up_gif);
                }
            ...
            $(charactor_box1).find('.up_gif').hide();
         },500);
