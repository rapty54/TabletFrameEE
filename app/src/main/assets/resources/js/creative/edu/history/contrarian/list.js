$(function () {
	...
	$('#list').on('click', '.detailPage', function () {
		...
		if (SessionUtils.isLogin()) {
			location.href = "/creative/edu/history/contrarian/detail?boardId=" + $(this).data('seq') + "&page=" + page;
		}
	});
	...
	$('#btn-teacher-about-layer').bind('click', function () {
		Layer.openLayer({
			url: '/creative/edu/history/contrarian/teacher/about.popup',
...
function getList() {
	...
	Ajax.execute({
		url: '/creative/edu/history/contrarian/contrarianList',
		data: {
