$(function () {
			...
			$('#content').on('click','.detailPage',function(){
				...
				if (SessionUtils.isLogin()) {
					location.href = "/creative/edu/reading/detail?boardId=" + $(this).data('seq')+"&page="+page;
				}
			});
			...
			$('#btn-teacher-about-layer').bind('click', function() {
				Layer.openLayer({
					url: '/creative/edu/reading/teacher/about.popup',
		...
		function getList() {
			...
			$tabConts = $('#content');
			Ajax.execute({
				url: '/creative/edu/reading/content.html',
