$(function () {
	...
	$('#list').on('click', '.detailPage', function () {
		...
		if (SessionUtils.isLogin()) {
			location.href = "/creative/career/jobplay/detail?boardId=" + $(this).data('seq') + "&page=" + page;
		}
	});
	...
	$('#btn-teacher-about-layer').bind('click', function () {
		Layer.openLayer({
			url: '/creative/career/jobplay/teacher/about.popup',
...
function getList() {
	...
	Ajax.execute({
		url: '/creative/career/jobplay/jobplayList',
		data: {
