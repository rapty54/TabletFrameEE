 ...
 */
	this.init_naver_id_login = function ()
	{
		...
		{
			naver_id_login_contents="<a href='"+naver_id_login_url+"' "+naver_id_popup_option+" id='naver_id_login_anchor'><img src='/resources/images/common/login_naver.png' border='0'  width='28' height='28'></a> ";
		}
		else if (this.button_type == BANNER_SMALL_TYPE)
		{
			naver_id_login_contents="<a href='"+naver_id_login_url+"' "+naver_id_popup_option+" id='naver_id_login_anchor'><img  src='/resources/images/member/login_naver.png' border='0'  width='56' height='56'></a> ";
		}
		else if (this.button_type == BANNER_BIG_TYPE)
		{
			naver_id_login_contents="<a href='"+naver_id_login_url+"' "+naver_id_popup_option+" id='naver_id_login_anchor'><span class='sns_log_btn naver' ></span></a> ";
		}
		else if (this.button_type == BANNER_JOIN_TYPE)
		{
			naver_id_login_contents="<a href='"+naver_id_login_url+"' "+naver_id_popup_option+" id='naver_id_login_anchor'><img  src='/resources/images/member/logo_naver.png' border='0'  width='82' height='83'></span></a> ";
		}
		else if (this.button_type == BANNER_THEMA_TYPE)
		{
			naver_id_login_contents="<a href='"+naver_id_login_url+"' "+naver_id_popup_option+" id='naver_id_login_anchor'><img  src='/resources/images/member/popLogin_naver.png' border='0'  ></span></a> ";
		}
		else if (this.button_type == BANNER_CUSTOM_TYPE)
		{
			naver_id_login_contents="<a href='"+naver_id_login_url+"' "+naver_id_popup_option+" id='naver_id_login_anchor'><img  src='/resources/images/member/login_naver.png' border='0'  width='" + this.button_height + "' height='" + this.button_height + "'></a> ";
		}
		else
		{
			naver_id_login_contents="<a href='"+naver_id_login_url+"' "+naver_id_popup_option+" id='naver_id_login_anchor'><span class='sns_log_btn naver' ></span></a> ";
