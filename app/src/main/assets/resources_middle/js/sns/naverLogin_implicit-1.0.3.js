 ...
 * @private
 */
	this.init_naver_id_login = function (id)
	{
		id = id == undefined ? 'naver_id_login' : id;
		var naver_id_login = document.getElementById(id);
		...
		{
			naver_id_login_contents="<a href='"+naver_id_login_url+"' "+naver_id_popup_option+" id='naver_id_login_anchor'><img src='../../images/renew/ico/login_naver.png' border='0'width='28' height='28'></a> ";
		}
		...
		{
			naver_id_login_contents="<a href='"+naver_id_login_url+"' "+naver_id_popup_option+" id='naver_id_login_anchor'><img src='../../images/common/popLogin_naver.png' border='0'></span></a> ";
		}
		else
		{
			naver_id_login_contents="<a href='"+naver_id_login_url+"' "+naver_id_popup_option+" id='naver_id_login_anchor'><span class='sns_log_btn naver'></span></a> ";
