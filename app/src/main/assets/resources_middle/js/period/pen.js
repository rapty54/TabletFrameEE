...
function updateSliderLineWidth( value ){
	...
	$( '#pen-stroke' ).slider( 'setValue', value, true );
	$( '#figure-stroke' ).slider( 'setValue', value, true );
}

function updateSliderAlpha( value ) {
	$("#transparent-bar").css("width", (value)+"%");
	$("#transparent-bar-txt").text(value+"%");
	$( '#pen-transparent' ).slider( 'setValue', value, true );
	$( '#figure-transparent' ).slider( 'setValue', value, true );
}

function updateSlider( id, value ){
	$( '#' + id ).slider( 'setValue', value, true );
}
