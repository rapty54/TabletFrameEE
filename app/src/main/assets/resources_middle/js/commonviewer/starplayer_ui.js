function initScriptUI(player) {
	...
	*/
	...
	function updateDuration(duration) {
		...
		if ($("#text_duration2", parent.document).length > 0) {
			$("#text_duration2", parent.document).text(formatTime(duration));	
		}
	}
	...
	function toggleRepeat() {
		...
		//구간반복 수정으로 설정하는 부분
/*		player.setRepeatStartTime(100);
		player.setRepeatEndTime(102);
		updateRepeatRangeChange(100,102);*/
	}
