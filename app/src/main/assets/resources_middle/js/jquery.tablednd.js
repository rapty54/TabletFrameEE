    ...
    $('table').each(function () {
        if ($(this).data('table') == 'dnd') {
            ...
            $(this).tableDnD({
                ...
                dropGrouping: $(this).data('dropgrouping') || false,
                noGroupClass: $(this).data('nogroupclass') == undefined && "nogroup" || $(this).data('nogroupclass'),
...
window.jQuery.tableDnD = {
    ...
    moveVerticle: function (moving, currentRow) {
    	var config       = this.currentTable.tableDnDConfig;
    	var selected = $(this.dragObject).attr("class").split(" ")[1];
        if (0 != moving.vertical && currentRow && this.dragObject != currentRow && this.dragObject.parentNode == currentRow.parentNode){
        	if($(this.dragObject).parent().find("tr").siblings("."+selected).length!=1 && config.dropGrouping == true && selected != config.noGroupClass){
        		for(var i=0; i<$(this.dragObject).parent().find("tr").siblings("."+selected).length; i++){
        			0 > moving.vertical && this.dragObject.parentNode.insertBefore($(this.dragObject).parent().find("tr").siblings("."+selected)[i], currentRow.nextSibling) || 0 < moving.vertical && this.dragObject.parentNode.insertBefore($(this.dragObject).parent().find("tr").siblings("."+selected)[i], currentRow);
        		}
        		
        	}
        	else{
        		0 > moving.vertical && this.dragObject.parentNode.insertBefore(this.dragObject, currentRow.nextSibling) || 0 < moving.vertical && this.dragObject.parentNode.insertBefore(this.dragObject, currentRow);
        	}
        }
    },
