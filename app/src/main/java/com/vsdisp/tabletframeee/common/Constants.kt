...
const val ACTIVATE_WV_CHROME_DEBUGGER = false // chrome://inspect 사용 하여 크롬 브라우저 에서 디버깅을 하고자 할때 배포때는 false
...
const val ACTIVATE_IS_CHROME_DEBUGGER = false // chrome console debugger 배포 때는 false
